	  ...
	  results.rows.forEach(element => tableText += 
										"<tr><td>\
												<form id='projectform' action='/openProject' method='post'>\
													...
													+ "<input type='submit' value='" + element.title + "'>\
												</form>\
											</td>\
